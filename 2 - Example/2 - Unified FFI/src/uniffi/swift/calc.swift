...
private extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_calc_288_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_calc_288_rustbuffer_free(self, $0) }
    }
}
...
public func mul(a: Int64, b: Int64) -> Int64 {
    return try! FfiConverterInt64.lift(
        try!
...
public func div(a: Int64, b: Int64) -> Int64 {
    return try! FfiConverterInt64.lift(
        try!
